...
return [
    'routes' => [
        ...
        ['name' => 'admin_api#enableZimbraAuthentication', 'url' => '/api/1.0/EnableZimbraAuthentication', 'verb' => 'POST'],
        ['name' => 'admin_api#disableZimbraAuthentication', 'url' => '/api/1.0/DisableZimbraAuthentication', 'verb' => 'POST']
    ]
];
